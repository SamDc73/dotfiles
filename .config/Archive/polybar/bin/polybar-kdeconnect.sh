...
COLOR_DISCONNECTED='#000000'       # Device Disconnected
COLOR_NEWDEVICE='#000000'          # New Device
COLOR_BATTERY_90='#000000'         # Battery >= 90
COLOR_BATTERY_80='#000000'         # Battery >= 80
COLOR_BATTERY_70='#000000'         # Battery >= 70
COLOR_BATTERY_60='#000000'         # Battery >= 60
COLOR_BATTERY_50='#000000'         # Battery >= 50
COLOR_BATTERY_LOW='#000000'        # Battery <  50
